  ...
  return (
    <div className="col-span-full lg:col-span-2 w-full lg:w-[774px] h-auto lg:h-[318px] bg-zinc-900/80 backdrop-blur-xl border border-zinc-800 rounded-3xl p-6 hover:border-red-500/50 transition-all duration-500 shadow-2xl flex flex-col justify-between mx-auto lg:mx-0">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <motion.div
          className="flex flex-shrink-0 mx-auto lg:mx-0"
          whileHover={{
            scale: 1.05,
            rotateX: 5,
            rotateY: -5,
      ...
      {/* Bottom section - Social icons + CTA button */}
      <div className="flex items-center gap-2 flex-wrap mt-4 w-fit">
        {/* GitHub */}
        <a
        ...
        <a
          ...
          download
          className="px-6 py-3 bg-white text-black font-medium rounded-xl hover:bg-red-500 hover:text-white transition-all duration-300 flex items-center gap-2 shadow-lg"
        >
